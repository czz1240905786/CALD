...
def get_coco(root, image_set, transforms, mode='annotation'):
    anno_file_template = "{}_{}_gpl.json"
    # anno_file_template = "{}_{}.json"
    # PATHS = {
    #     "labeled": ("labeled_pool", os.path.join("annotations", anno_file_template.format("labeled", mode))),
    #     "unlabeled": ("unlabeled_pool", os.path.join("annotations", anno_file_template.format("unlabeled", mode))),
    #     "test": ("test_pool", os.path.join("annotations", anno_file_template.format("test", mode))),
